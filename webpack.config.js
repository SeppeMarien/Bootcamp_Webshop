...
const allNodeModulesExcept = nodeModulesToInclude =>
  new RegExp(`node_modules[\\/|\\\\](?!(${nodeModulesToInclude.join('|')})).*`, 'i');
  ...
  const config = {
    ...
    module: {
      rules: [
        ...
        {
          test: /\.(sa|sc|c)ss$/,
          use: [!isProduction ? 'style-loader' : MiniCssExtractPlugin.loader, 'css-loader', 'sass-loader'],
        },
        {
